...
import { OntologyClass } from 'sherlock-rdf/lib/ontology'
import { OG, Resource } from 'sherlock-rdf/lib/resource'
import { RDF_TYPE } from '../../data/ontologies/RDF'
import { PH } from './PH'
import Values from './Values'
import React from 'react'
import { getPrefix } from '../../constants/RDF_PREFIXES'
...
export default function ({ resource, edit }: Props) {
  ...
  >
    <Box sx={{
      ...
      <Button variant='outlined' sx={{ cursor: 'default', height: 42 }}>ANNULER</Button>
      <Button variant='outlined' sx={{ cursor: 'default', height: 42 }}>ENREGISTRER</Button>
    </Box>
