...
import { useResourceIdentity } from '@/hooks/useResourceIdentity'

export default function Resource() {
  const [searchParams] = useSearchParams()
  const resourceUri = searchParams.get('resource') || ''

  const { data: resourceIdentity, isLoading: resourceIdentityIsLoading } = useResourceIdentity(resourceUri)
  console.log(resourceIdentity)

  if (!resourceUri) return <div className='section-divider' />

  let projectId = null

  return <div>Caca : {resourceUri}</div>
}
// ////////////////////////////////////////////////////////////////////////////////
// //
// // SPARQL
