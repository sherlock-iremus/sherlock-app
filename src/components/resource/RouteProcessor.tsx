...
export default function Resource() {
    ...
    const getResourceSparqlQuery = useMemo(() => getResourceByUrlFragment(urlFragment), [urlFragment])
    let { data } = sparqlApi.endpoints.getSparqlQueryResult.useQuery(getResourceSparqlQuery)
